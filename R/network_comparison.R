...
#'
#' @param file_path Path to Orthogroups/Orthogroups.tsv file generated by OrthoFinder.
#'
#' @author Fabricio Almeida-Silva
#' @return A 3-column data frame with orthogroups, species IDs and gene IDs, respectively.
