...
levels are inhibited or induced in particular tissues. Of note, when using 
categorical variables the function `module_trait_cor()` only works with a 
single variable at a time. Alternatively, one can use any number of continuous 
variables (e.g., metabolite content, protein concentration, height) or discrete 
variables (e.g., disease index) as traits.[^5]
