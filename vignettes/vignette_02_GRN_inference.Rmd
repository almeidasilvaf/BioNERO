---
title: "Gene regulatory network inference with BioNERO"
author: 
...
```{r}
grn <- exp2grn(exp = final_exp, regulators = zma.tfs$Gene)
head(grn)
```
...
```{r genie3}
# Using 10 trees for simplicity. Default: 1000.
...
After inferring the GRN, `BioNERO` allows users to perform some common post-inference analyses.

## Hub gene identification

GRN hubs are defined as the top 10% most highly connected regulators, but this percentile is flexible.[^2] They can be identified with `get_hubs_grn()`. 
