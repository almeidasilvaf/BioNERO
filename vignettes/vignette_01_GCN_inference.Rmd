...
You can also change the color palette and transpose the plot.

```{r modtraitcor_transpose, fig.width=8, fig.height=4}
plot_module_trait_cor(MEtrait, palette = "PRGn", transpose = TRUE)
```
